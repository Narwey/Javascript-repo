...
let products = [
    { id: 1, name: 'iPhone', price: 1099.99 , description : 'this is an iphone with a good price' },
    { id: 2, name: 'Samsung Galaxy S21', price: 999.99 , description : 'this is an samsung with a good price' },
    { id: 3, name: 'Sony PlayStation 5', price: 499.99 , description : 'this is a samsung with a good price' },
    { id: 4, name: 'MacBook Pro 16', price: 2399.99 , description : 'this is a MacBook Pro with a very good price' },
    { id: 5, name: 'DJI Mavic Air 2', price: 799.99 , description : 'i dont know what is this XD'},
  ];
